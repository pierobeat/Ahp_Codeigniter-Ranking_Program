  <div class="card">
    <div class="card card-plain">
      <div class="content table-responsive table-full-width">
        <form class="" action="<?php echo site_url('dashboard_admin/UpdateNilai'); ?>" method="post">
          <table class="table table-hover table-striped">
            <?php foreach ($nilK as $a){
              ...
              <?php foreach ($listNil as $b){
                ...
                <tr>
                  ...
                  <td>
                    <?php echo $b->nama_kriteria; ?>&nbsp&nbsp&nbsp&nbsp<a href="#" id="shwIn<?php echo $rc ?>" data-toogle="tooltip" data-placement="top" title="Klik Untuk Bantuan Menilai">?</a>
                  </td>
                  <td>
            ...
            <tr>
              <td colspan="2"><a class="btn btn-warning btn-fill" href="<?php echo site_url('dashboard_admin/Calon'); ?>" onmouseover="demo.showBack('top','center');" name="button"><i class="pe-7s-back"></i>&nbsp&nbsp Kembali</a>
